...
exports.createServerActionClient = createServerActionClient;
var ssr_1 = require("@supabase/ssr");
var ssr_2 = require("@supabase/ssr");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    cookieStore = _a.sent();
                    return [2 /*return*/, (0, ssr_2.createServerClient)(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, {
                            cookies: {
                                get: function (name) {
                                    var _a;
...
// Server Action Supabase Client (read-write)
